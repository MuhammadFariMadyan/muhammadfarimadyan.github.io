(() => {
  ...
  /* Jumbotron section */
  jumboSection.style.backgroundImage =
    `linear-gradient( rgba(0, 0, 0, .8), rgba(255, 255, 255, .4)), url(` +
    data.jumbo.img +
    `)`;
  ...
  /* Portfolio Section */
  portfolioSection.style.background =
    `url(` + portfolio.backgroundImg + `)  center center fixed`;
